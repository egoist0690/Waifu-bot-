...
async def generate_start_message(client, message):
    ...
    caption = (
        ...
        f"<tg-emoji custom_emoji_id=\"5424867354993513047\">🌸</tg-emoji> <b>ᴀʀᴀ ᴀʀᴀ~ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ ʙᴜᴛᴛᴇʀғʟʏ ᴍᴀɴsɪᴏɴ!</b> <tg-emoji custom_emoji_id=\"5424867354993513047\">🌸</tg-emoji>\n\n"
        ...
        f"<tg-emoji custom_emoji_id=\"5805686638952584277\">⦾</tg-emoji> <b>ᴍɪssɪᴏɴ:</b> ɪ ᴛʀᴀᴄᴋ ᴅᴏᴡɴ ʀᴏᴀᴍɪɴɢ sʟᴀʏᴇʀs ᴀɴᴅ ᴛʀᴀᴘ ᴡᴀɴᴅᴇʀɪɴɢ ᴅᴇᴍᴏɴs ɪɴ ʏᴏᴜʀ ᴄʜᴀᴛs.\n"

        f"<tg-emoji custom_emoji_id=\"5805686638952584277\">⦾</tg-emoji> <b>ᴛʀᴀɪɴɪɴɢ:</b> ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴜsᴇ /help ᴛᴏ ʀᴇᴀᴅ ᴍʏ ᴄᴜsᴛᴏᴍ ᴛʀᴀɪɴɪɴɢ ᴍᴀɴᴜᴀʟs.\n"

        f"━━━━━━━▧▣▧━━━━━━━\n"

        f"<tg-emoji custom_emoji_id=\"6026292029179301727\">⚡</tg-emoji> <b>ᴘᴜʟsᴇ:</b> <code>{ping}</code> ᴍs\n"

        f"<tg-emoji custom_emoji_id=\"6131657524094440916\">⏳</tg-emoji> <b>ʀᴇsᴛ ᴢᴏɴᴇ:</b> <code>{uptime}</code></blockquote>"
    ...
    buttons = [
        ...
        [InlineKeyboardButton("<tg-emoji custom_emoji_id=\"5807617080723249103\">🦋</tg-emoji> ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ", url=f"https://t.me/{bot_user.username}?startgroup=true")],

        [

            InlineKeyboardButton("<tg-emoji custom_emoji_id=\"6033130355848908316\">💜</tg-emoji> sᴜᴘᴘᴏʀᴛ", url="https://t.me/+fPjchISAGnc3OGJl"),

            InlineKeyboardButton("<tg-emoji custom_emoji_id=\"5041888071851705019\">📢</tg-emoji> ᴜᴘᴅᴀᴛᴇs", url="https://t.me/+wjJbHQ9DQzM1OTE1")

        ],

        [

            InlineKeyboardButton("<tg-emoji custom_emoji_id=\"5805686638952584277\">🧪</tg-emoji> ʜᴇʟᴘ", callback_data="open_help"),

            InlineKeyboardButton("<tg-emoji custom_emoji_id=\"6026292029179301727\">👤</tg-emoji> ᴏᴡɴᴇʀ", url=f"https://t.me/EGOIST_6969")
...
async def generate_group_start_message(client):
    ...
    caption = (
        ...
        f"<tg-emoji custom_emoji_id=\"5807617080723249103\">🦋</tg-emoji> <i>ғʟᴀᴘ, ғʟᴀᴘ... ɪ ᴀᴍ</i> <b>{bot_user.first_name}</b> <tg-emoji custom_emoji_id=\"5424867354993513047\">🌸</tg-emoji>\n\n"
...
def find_help_modules():
    ...
    for module_name, module_data in HELP_DATA.items():
        ...
        buttons.append(InlineKeyboardButton(
            ...
            f"<tg-emoji custom_emoji_id=\"5805686638952584277\">📋</tg-emoji> {button_name}",
...
async def show_help_menu(client, query: CallbackQuery):
    ...
    buttons.append([InlineKeyboardButton(
        ...
        "<tg-emoji custom_emoji_id=\"5805686638952584277\">⬅️</tg-emoji> ʀᴇᴛᴜʀɴ ᴛᴏ ᴍᴀɴsɪᴏɴ",
    ...
    text = (
        ...
        "<tg-emoji custom_emoji_id=\"5805686638952584277\">⚙️</tg-emoji> <b>🦋 ʙᴜᴛᴛᴇʀғʟʏ ᴍᴀɴsɪᴏɴ ʜᴇʟᴘ ᴍᴇɴᴜ</b>\n\n"
...
async def show_help(client, query: CallbackQuery):
    ...
    try:
        ...
        buttons = [[InlineKeyboardButton(
            ...
            "<tg-emoji custom_emoji_id=\"5805686638952584277\">⬅️</tg-emoji> ʙᴀᴄᴋ ᴛᴏ ʟᴀʙᴏʀᴀᴛᴏʀʏ",
        ...
        full_text = (
            ...
            f"<tg-emoji custom_emoji_id=\"5805686638952584277\">🧪</tg-emoji> <b>{module_name.upper()} ᴄʟɪɴɪᴄᴀʟ ʀᴇᴄᴏʀᴅs:</b>\n\n"
